...
from .distill_postprocessor import DistillPostprocessor
from .otd_postprocessor import WDPostprocessor
from .otdp_postprocessor import OTDP
from .gmme_postprocessor import GMMEPostprocessor
...
def get_postprocessor(config: Config):
    postprocessors = {
        ...
        'distill': DistillPostprocessor,
        'otd': WDPostprocessor,
        'otdp': OTDP,
        'gmme': GMMEPostprocessor
    }
