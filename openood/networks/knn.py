...
def generate_outliers(ID, input_index, negative_samples, ID_points_num=224,
                      K=30, select=1, cov_mat=0.1, sampling_ratio=1.0,
    ...
    # negative_sample_cov = cov_mat * negative_samples.repeat(pic_nums,1)
